...
class OOTDiffusionHD:
    ...
    def __call__(self,
        ...
        with torch.no_grad():
            ...
            if model_type == 'hd':
                prompt_embeds = self.text_encoder(self.tokenize_captions([""], 2))[0] # .to(self.gpu_id))[0]
                prompt_embeds[:, 1:] = prompt_image[:]
            elif model_type == 'dc':
                prompt_embeds = self.text_encoder(self.tokenize_captions([category], 3))[0] # .to(self.gpu_id))[0]
